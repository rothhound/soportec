...
class LaboratoriesControllerTest < ActionController::TestCase
  ...
  test "should create laboratory" do
    assert_difference('Laboratory.count') do
      post :create, laboratory: { airConditioning: @laboratory.airConditioning, capacity: @laboratory.capacity, floor: @laboratory.floor, numComputers: @laboratory.numComputers, numer: @laboratory.numer, sound: @laboratory.sound }
    end
  ...
  test "should update laboratory" do
    put :update, id: @laboratory, laboratory: { airConditioning: @laboratory.airConditioning, capacity: @laboratory.capacity, floor: @laboratory.floor, numComputers: @laboratory.numComputers, numer: @laboratory.numer, sound: @laboratory.sound }
    assert_redirected_to laboratory_path(assigns(:laboratory))
  end
