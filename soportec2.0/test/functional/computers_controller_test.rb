...
class ComputersControllerTest < ActionController::TestCase
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post :create, computer: { display: @computer.display, keyboard: @computer.keyboard, motherboard: @computer.motherboard, mouse: @computer.mouse, processor: @computer.processor, ram: @computer.ram, videocard: @computer.videocard }
    end
  ...
  test "should update computer" do
    put :update, id: @computer, computer: { display: @computer.display, keyboard: @computer.keyboard, motherboard: @computer.motherboard, mouse: @computer.mouse, processor: @computer.processor, ram: @computer.ram, videocard: @computer.videocard }
    assert_redirected_to computer_path(assigns(:computer))
  end
